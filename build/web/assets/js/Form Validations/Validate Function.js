export function validate(testId, testIdLabel, regex, regexTestErrorMessage, minimumLength, maximumLength, isRequired, hasMinimumLength, hasMaximumLength) {
...
export function validateNumber(testId, testIdLabel, regex, regexTestErrorMessage, isRequired) {
    let isValidated = false;
