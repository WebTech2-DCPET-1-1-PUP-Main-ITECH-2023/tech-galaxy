            ...
            <div class = "container-sm m-4">
                <div class = "border-update py-4">
                    <form method="POST" action="<%=request.getContextPath()%>/products/create">
                        <h1 class="color-white modal-title fs-5 primary-font center mb-4">Add Product Form</h1>
                        ...
                        <div class="row align-items-center my-2 d-flex justify-content-center">
                            ...
                            <div class="col-5">
                                <input type="text" id="description" name="description" class="form-control product-inputs" placeholder="Required; Letters only; must be at least 3 characters">
                            </div>
                        </div>
                        <div class="row align-items-center d-flex justify-content-center">
                            <p class = "col-1"></p>
                        ...
                        <div class="row align-items-center my-2 d-flex justify-content-center">
                            ...
                            <div class="col-5">
                                <input required type="text" id="size" name="size" class="form-control product-inputs" placeholder="Alphanumeric; [e.g., 30 mL]">
                            </div>
                        </div>
                        <div class="row align-items-center d-flex justify-content-center">
                            <p class = "col-1"></p>
                        ...
                        <div class = "d-flex justify-content-center">
                           <button class="btn primary-font mt-3" id = "addProductsSave">Add Products</button>
                        </div>
                    </form>
                </div>
            </div>
