...
<html>
    <head>
        ...
        <script type="module" src="<%=request.getContextPath()%>/assets/js/File Manipulations/PathChangeForModals.js"></script>
    </head>
    <body>
        <nav class="navbar">
            <div class="container-fluid d-flex flex-wrap align-items-center justify-content-between py-2 px-4">
                ...
                <div class = "d-flex flex-row flex-wrap align-items-center justify-content-center secondary-font">
                    ...
                    <form method="post" action = "<%=request.getContextPath()%>/logOut">
                        <button type="submit" class="btn ms-3 primary-font" id="clientLogOut">Log Out</button>
                    </form>
